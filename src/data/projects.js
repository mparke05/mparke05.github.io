    ...
    sections: [
      {
        ...
        body: `The final drive ratio was determined using a laptime simulator to maximize competition points. Tradeoffs included acceleration time, top speed, and fuel efficiency. A decision matrix was used to determine the maximum points gain/loss from each final drive ratio. The ideal 44T sprocket was unfeasible due to size constraints within the chassis, so 40T was selected as it was the closest candidate in performance—slightly slower acceleration but faster in endurance.`,
        images: [
